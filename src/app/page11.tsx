...
export default function Home() {
  ...
  // Handle merged cells: fill merged range except top-left with empty string
    ...
    merges.forEach((merge) => {
      ...
      for (let r = s.r; r <= e.r; r++) {
        for (let c = s.c; c <= e.c; c++) {
          if (r === s.r && c === s.c) continue; // keep top-left value
          data[r][c] = ""; // fill others with empty string
        }
      }
    });
